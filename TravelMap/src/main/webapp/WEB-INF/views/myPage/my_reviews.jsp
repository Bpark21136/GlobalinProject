...
<%ArrayList<Map<String,Object>> reviews = (ArrayList<Map<String,Object>>) request.getAttribute("reviews");%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<div class="container">
		<div class="bbs">
		<div class="header">
			<header class="bTitle">내 리뷰</header>
		</div>
				...
				<table class="table table-striped" style="text-align: center; border: 0">
					...
					<tbody class="bbsListTbody">
						...
						<tr class="bbsListLine">
							<td class="listINum"><%=reviews.get(i).get("REVIEWID")%></td>
							<td class="listITitle">
							<a class="viewLink" href="" data-rid="<%=reviews.get(i).get("REVIEWID")%>"><%=reviews.get(i).get("TITLE")%></a></td>
							<td class="listIName"><%=reviews.get(i).get("USERID")%></td>
							<td class="listIDate"><%=reviews.get(i).get("DATE")%></td>
						</tr>
						<%}%>
					</tbody>
				</table>
				<div style="display:flex;justify-content: center;align-items: center;">
					<button style="width:36px;height:36px"class="btn btn-primary" onclick="myReviewPrev(<%=request.getParameter("page")%>)">
			                   <i class="fa fa-angle-left"></i>
			        </button>
			        <span style="margin-left:10px;color: var(--white-color);" id="my-review-current-page">
			        <%=request.getParameter("page")%>
			        </span>
			        <span style="color: var(--white-color);">
			        /
			        </span>
			        <span style="margin-right:10px;color: var(--white-color);" id="my-review-max-page">
			        ${maxPage}
			        </span>
			        <button style="width:36px;height:36px"class="btn btn-primary" onclick="myReviewNext(<%=request.getParameter("page")%>)">
