			...
			<table class="table table-striped" style="text-align: center; border: 0">
				...
				<tbody class="bbsListTbody">
					<tr class="bbsListLine">
						...
						<td class="listITitle">
						<a class="viewLink" href="/WEB-INF/views/content/bbsDetailPage/bbsView.jsp">안녕하세요</a></td>
					...
					<tr class="bbsListLine">
						...
						<td class="listITitle">
						<a class="viewLink" href="/src/main/webapp/WEB-INF/views/content/bbsDetailPage/bbsView.jsp">안녕하세요</a></td>
						<td class="listIName">홍길동</td>
						<td class="listIDate">2017-05-04</td>
					</tr>
